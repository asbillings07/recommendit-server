...
const { createUser, deleteUser, updateUser, findUserByEmail, findUserByToken, findUserById, findUserByObj, addSavedRecommendation, findTokenByUser, addUserToken, createSaltHash } = require('./userFunctions')
...
module.exports = {
    ...
    createUser, deleteUser, updateUser, findUserByEmail, findUserByToken, findUserById, findUserByObj, addSavedRecommendation, findTokenByUser, addUserToken, createSaltHash
}